...
namespace CockBlockDefense
{
    public class StartScreen
    {
        ...
        {
            this.game = game;
            texture = game.Content.Load<Texture2D>(@"bg/StartScreenBg");
            button_texture[START_BUTTON_INDEX] =
                game.Content.Load<Texture2D>(@"buttons/startButton");
            button_texture[EXIT_BUTTON_INDEX] =
                game.Content.Load<Texture2D>(@"buttons/exitButton");
        ...
        protected  void initialize()
        {
            ...
            int x = 87;
            int y = (int)(game.GraphicsDevice.Viewport.Height * 0.8) -
